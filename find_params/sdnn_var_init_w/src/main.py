...
def main():
    ...
    path = dirname(dirname(realpath(__file__))) ## modify by path to datasets
    ...
    first_net.weights_ID = '0'
    first_net.w_factor=1
    first_net.w_init=float(sys.argv[1])
    first_net.std_init=float(sys.argv[2])
    ...
    weight_path_list = [weights_path + 'weight_' + str(i) + '_' + '0' + '.npy' for i in range(len(network_params) - 1)]
